...
def setup_cfg():
    ...
    cfg.MODEL.WEIGHTS = "./pretrained/R_101_FPN_UAV_SEGM_last.pth"
...
video_visualizer = VideoVisualizer({'thing_classes': ['car', 'truck', 'bus', 'person']})

imgdir = './test_images/DJI_0080'
